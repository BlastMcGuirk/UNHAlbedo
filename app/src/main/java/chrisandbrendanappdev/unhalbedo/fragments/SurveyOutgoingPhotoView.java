 ...
 */
public class SurveyOutgoingPhotoView extends SurveyFragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceLayout) {
        Image img = data.getOutgoingImage();
        File file = data.getOutgoingImageFile();
    ...
    void addOnClickListeners() {
        mRetakePhotoButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                data.setOutgoingImage(null, null);
                data.getOutgoingImageReader().close();
                saveDataAndContinueWithoutAddingToBackStack(new SurveyOutgoingPhoto());
            }
        });
        mUsePhoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                data.calculateAlbedoFromImages();
